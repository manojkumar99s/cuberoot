...
function chart(targetID, jsonPath, color, axisXkey, axisYkey, divRatio, nestKey, dimension, axis){
    ...
    //core variables for chart
        ...
        outerHeight = width * parseInt(dimension.height)/100,
        legendH = 50,
